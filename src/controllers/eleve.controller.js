...
module.exports.addEleve =  async (req, res) => {
    const { nom, prenoms, sexe, date_naissance, filiere, ecole } = req.body;

    //ajouter un type utilisateur
    const result = await db.query(eleveQueries.addEleve, [nom, prenoms, sexe, date_naissance, filiere, ecole])
...
module.exports.updateEleve = async (req, res) => {
    ...
    if (noEleveFound) {
       ...
       const results = await db.query(eleveQueries.updateEleve, [nom, prenoms, sexe, date_naissance, filiere, ecole, id])
